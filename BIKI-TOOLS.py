...
╚═╝░░░░░╚═╝╚═╝░░╚═╝╚═╝╚═════╝░╚═╝╚═╝░░╚═╝╚═╝
\x1b[92;1m===================================>\x1b[92;1m
\x1b[93;1m Authur       \x1b[92;1m=>         \x1b[93;1mBIKI MAHAMOOD
\x1b[93;1m Whatsp       \x1b[92;1m=>        \x1b[93;1m+919957975493
\x1b[93;1m Github       \x1b[92;1m=>         \x1b[93;1mbiki404-cyber
\x1b[92;1m===================================>\x1b[92;1m
"""%(h))
...
def crack2(idf,pwv):
	...
	fff = '%'
	print('\r%s [BIKI] %s/%s  OK*%s | CP*%s => %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				if 'ya' in oprek:
					...
					print('\r%s [BIKI-CP] %s|%s        '%(b,idf,pw))
...
if __name__=='__main__':
	...
	os.system("xdg-open https://www.facebook.com/bikiterabap")
	menu()
